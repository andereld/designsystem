    ...
    for (let row = 0; row < rows; row++) {
        ...
        for (let dayx = 0; dayx < 7; dayx++) {
            const date = {
                ...
                isSelected:
                    this.hasSelected() && currentDate.equal(this.selectedDate),
...
SimpleCalendar.prototype.isDateWithinDateRange = function isDateWithinDateRange(
    date,
) {
...
SimpleCalendar.prototype.selectDateString = function selectDateString(
    datestring,
) {
